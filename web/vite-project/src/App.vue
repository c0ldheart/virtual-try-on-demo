...
const img = (type: 'cloth' | 'human', id: string) => `https://raw.githubusercontent.com/c0ldheart/virtual-try-on-demo/v1.0.0/assert/${type}/${id}.jpg`
...
<template>
  <div class="p-4 flex">
    ...
    <div class="w-3/5">
      <div class="flex flex-col" v-for="t of types" v-show="type === t">
